...
# Returns true/false if a coordinate contains a piece.
  ...
  def opponent_can_capture_piece_causing_check?(color)
    ...
    # Check if it would be valid for the opponent_piece move to the position of the piece causing check
  ...
  # Remove the opponent king from the remaining_opponent_pieces array, since it can't block the piece causing check
  ...
  # Iterate through opponent king's valid surrounding coordinate sets
    ...
    # Check if it would be valid for the opponent_king to move to the specified surrounding coordinate set
      ...
      # Check if the opponent_king wouldn't obstructed while attempting to move to the specified surrounding coordinate set
        ...
        # Check if a piece player to the opponent_king doesn't occupy the specified surrounding coordinate set
  ...
  # Query for opponent king piece
    @opponent_king = pieces.where(game_id: id, type: 'King').where.not(color: color).last    
  ...
  # Initialize array to store coordinate sets between player piece causing check and opponent king
