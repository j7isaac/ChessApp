...
# Returns true/false if a coordinate contains a piece.
  ...
  private
    ...
    def populate_board!
    # white pieces
      Rook.create(game_id: id, x_coordinate: 8, y_coordinate: 1, color: 'white', player_id: white_player_id)
      Rook.create(game_id: id, x_coordinate: 8, y_coordinate: 8, color: 'white', player_id: white_player_id)
  
      Knight.create(game_id: id, x_coordinate: 8, y_coordinate: 2, color: 'white', player_id: white_player_id)
      Knight.create(game_id: id, x_coordinate: 8, y_coordinate: 7, color: 'white', player_id: white_player_id)
  
      Bishop.create(game_id: id, x_coordinate: 8, y_coordinate: 3, color: 'white', player_id: white_player_id)
      Bishop.create(game_id: id, x_coordinate: 8, y_coordinate: 6, color: 'white', player_id: white_player_id)
  
      Queen.create(game_id: id, x_coordinate: 8, y_coordinate: 4, color: 'white', player_id: white_player_id)
      King.create(game_id: id, x_coordinate: 8, y_coordinate: 5, color: 'white', player_id: white_player_id)
    ...
    # pawns
      [['white', 7], ['black', 2]].each do |color, x|
        (1..8).each do |i|
          ...
          Pawn.create(game_id: id, x_coordinate: x, y_coordinate: i, color: color, player_id: player)
        end  
      end
    end
